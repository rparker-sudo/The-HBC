...
page("admin/index.html", "club", "Calendar Admin | The HBC Volleyball Club",
 "Calendar editor and practice schedule builder for The HBC staff.",
 """    <section class="page-hero adm-hero">
      <div class="container">
        <div>
          <span class="eyebrow">Staff Only</span>
          <h1>Calendar Admin</h1>
          <p>Build the practice schedule, then fine-tune any practice on the calendar.</p>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="card adm-connect" id="adm-connect-card">
          ...
          <details class="adm-settings">
            ...
            <div class="adm-grid five">
              ...
              <label>Builder setup file<input id="s-configPath"></label>
            </div>
        ...
        <div id="adm-editor" hidden>
          <div class="adm-tabs" role="tablist">
            <button type="button" role="tab" data-tab="calendar" aria-selected="true">Calendar</button>
            <button type="button" role="tab" data-tab="builder" aria-selected="false">Schedule Builder</button>
            <button type="button" role="tab" data-tab="list" aria-selected="false">All events</button>
            <button type="button" role="tab" data-tab="help" aria-selected="false">Help</button>
          </div>
          ...
          <div data-panel="builder" hidden>
            <div id="sb-root"></div>
          </div>

          <div data-panel="list" hidden>
          ...
          <div data-panel="help" hidden>
            <div class="card">
              <h3>How the schedule builder works</h3>
              <ol>
                <li><strong>Season phases:</strong> label your three phases and set their dates. Add holidays so no practices land on them.</li>
              ...
              <p>A coach is never booked in two places at once, and a court never holds more than one full-court team (or two shared-court teams) at a time. Conflicts are shown in red on the calendar.</p>
            </div>
          </div>
    ...
    <dialog id="occ-dialog" class="cal-dialog adm-dialog">
      <form id="occ-form" novalidate onsubmit="return false">
        <button type="button" class="cal-close" id="occ-close" aria-label="Close">&times;</button>
        <h3 id="occ-title">Edit practice</h3>
        <p id="occ-series" class="sb-hint"></p>
        ...
        <p id="occ-error" class="adm-status err" role="alert"></p>
        <div class="adm-row wrap">
          <button class="btn btn-dark" type="button" id="occ-one">Save this practice only</button>
          <button class="btn btn-primary" type="button" id="occ-future">Save this &amp; all future practices</button>
        </div>
        <div class="adm-row wrap">
          <button class="adm-link danger" type="button" id="occ-cancel-one">Cancel this practice</button>
          <button class="adm-link danger" type="button" id="occ-cancel-future">Cancel this &amp; all future practices</button>
        </div>
      </form>
    </dialog>
""", head='\n  <meta name="robots" content="noindex, nofollow">', scripts=("events.js", "scheduler.js", "admin.js", "admin-calendar.js", "admin-scheduler.js"))
